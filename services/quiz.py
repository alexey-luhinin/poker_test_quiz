...
q4 = Question('BU(hero) vs BB<br /> \
              ...
              ['CBET/FOLD 25%', 'CBET/FOLD 33%', 'CHECK',
               'CBET/FOLD 66%', 'CBET/CALL 25%', 'CBET/CALL 33%'], 'CHECK')

q5 = Question('BU vs BB(hero)<br /> \
              <img class="card" src="/static/img/AC.png"> \
              <img class="card" src="/static/img/7H.png"> \
              <br />Bu opens 2.5bb, hero call. Flop bu cbet 33%, hero \
              call. Turn bu cbet 75%, hero call. River bu cbet 33%, hero?\
              <br />\
              <br />River (22.8 bb)<br /> \
              <img class="card" src="/static/img/AH.png"> \
...
q6 = Question('BU vs BB(hero)<br /> \
              ...
              <img class="card" src="/static/img/7H.png"> \
              <br />Bu opens 2.5bb, hero call. Flop bu cbet 33%, hero \
              call. Turn bu cbet 75%, hero call. River bu cbet 75%, hero?\
              <br />\
              <br />River (22.8 bb)<br /> \
              <img class="card" src="/static/img/AH.png"> \
              <img class="card" src="/static/img/10D.png"> \
...
q7 = Question('BU(hero) vs BB<br /> \
              ...
              <br />Hero opens 2.5bb, bb call. Flop hero cbet 25%, \
              villain call. bb checks, hero?\
              <br />\
              <br />Turn (8.25 bb)<br /> \
              <img class="card" src="/static/img/KH.png"> \
...
q8 = Question('BU(hero) vs BB<br /> \
              ...
              ['CBET/FOLD 25%', 'CBET/FOLD 33%', 'CHECK',
               'CBET/FOLD 66%', 'CBET/CALL 25%', 'CBET/CALL 33%'],
              'CBET/FOLD 66%')
...
q10 = Question('BU vs BB(hero)<br /> \
               ...
               <img class="card" src="/static/img/8D.png"> \
               <br />Bu opens 2.5bb, hero call. Flop bu cbet 33%, hero \
               call. Turn bu cbet 75%, hero call. River bu cbet 95%, hero?\
               <br />\
               <br />River (22.8 bb)<br /> \
               <img class="card" src="/static/img/KH.png"> \
               <img class="card" src="/static/img/10C.png"> \
...
q13 = Question('BU(hero) vs BB<br /> \
               ...
               <img class="card" src="/static/img/7D.png">',
               ['CBET 25%', 'CBET 33%', 'CHECK', 'CBET 50%',
                'CBET 66%', 'CBET 75%'], 'CBET 50%')
...
q17 = Question('BU vs SB(hero)<br /> \
               ...
               <br />Bu opens 2.5bb, Hero 3bet, villain call. Flop hero \
               cbet 50%, villain call. Turn hero cbet 50%, \
               villain call. Hero? \
               <br />\
               <br />River (86 bb)<br /> \
               <img class="card" src="/static/img/2H.png"> \
...
q18 = Question('BU(hero) vs MP<br /> \
               <img class="card" src="/static/img/QS.png"> \
               <img class="card" src="/static/img/JS.png"> \
               <br />Mp opens 2.5bb, Hero 3bet, villain call. Flop Mp \
               check, hero cbet 50%, villain call. Turn Mp check hero \
               cbet 66%, villain call. River Mp check? Hero? \
               <br />\
               <br />River (86 bb)<br /> \
               <img class="card" src="/static/img/9C.png"> \
               <img class="card" src="/static/img/4H.png"> \
...
q19 = Question('CO vs SB(hero)<br /> \
               ...
               <br />CO opens 2.5bb, Hero 3bet, villain call. Flop hero \
               cbet 50%, villain call. Hero? \
               <br />\
               <br />Turn (43 bb)<br /> \
               <img class="card" src="/static/img/4S.png"> \
               <img class="card" src="/static/img/2H.png"> \
...
q20 = Question('BU(hero) vs BB<br /> \
               <img class="card" src="/static/img/QC.png"> \
               <img class="card" src="/static/img/JH.png"> \
               <br />Hero opens 2.5bb, bb call. Flop hero cbet 33%, \
               villain call. bb checks, hero cbet 75%, villain call. \
               bb checks, Hero?<br /><i>villain is a one of the best \
               regs on limit</i>\
               <br />\
               <br />River (22.8 bb)<br /> \
               <img class="card" src="/static/img/8C.png"> \
